          ...
          <div className="maxwidth-sl mx-auto wrapper">
            ...
            <div className="pt-2">
              ...
              <div style={{ overflowX: 'auto' }}>
                  ...
                  <tbody>
                    ...
                    {recentWithdrawals.map((data, i) => (
                      <tr key={i + 1}>
                        ...
                        <td>
                          <Link to={`/admin/withdraws/${data.id}`}>
                ...
                <Link to="/admin/withdraws"><p>View All Withdrawal Requests</p></Link>
              </div>
            </div>
                  ...
                  <tbody>
                    ...
                    {recentACHTransfers.map((data, i) => (
                      <tr key={i + 1}>
                        ...
                        <td>{new Date(data.created_at).toDateString()}</td>
                        <td>
                          <Link to={`/admin/transfers/ach/${data.id}`}>
                            <button className="w-100 b-rad-s bg-primary co-white py-1">View</button>
                          </Link>
                        </td>
                      </tr>
                  ...
                  <tbody>
                    ...
                    {recentKYCUploads.map((data, i) => (
                      <tr key={i + 1}>
                        ...
                        <td>{new Date(data.created_at).toDateString()}</td>
                        <td>
                          <a href={data.filename} target="_blank" rel="noopener noreferrer">
                            view
                          </a>
                        </td>
                        <td>
