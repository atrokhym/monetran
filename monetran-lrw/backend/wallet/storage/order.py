...
def create_order(
    ...
    wyre_transfer_id: str,
    wyre_reservation_id: str,
) -> Order:
...
def update_order(
    ...
    wyre_transfer_id: Optional[str] = None,
    wyre_reservation_id: Optional[str] = None,
    wyre_reservation_url: Optional[str] = None,
    wyre_order_id: Optional[str] = None,
    wyre_authorization_url: Optional[str] = None,
):
