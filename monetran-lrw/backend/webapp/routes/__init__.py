...
def account_routes():
    ...
    account.add_url_rule(
        rule="/account/transactions-wyre",
        view_func=AccountRoutes.GetWyreTransactions.as_view("account_wyre_transactions"),
        methods=["GET"],
    )
    account.add_url_rule(
        rule="/account/transactions",
...
def cico_routes():
    ...
    cico.add_url_rule(
        rule="/account/quotes/<uuid:quote_id>/url",
        view_func=CicoRoutes.GetQuoteUrlView.as_view("get_quote"),
        methods=["GET"],
    )
    cico.add_url_rule(
        rule="/account/quotes/<uuid:quote_id>/status",
