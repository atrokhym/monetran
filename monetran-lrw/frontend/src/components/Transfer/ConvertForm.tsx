...
import { allCurrenciesWithBalanceOptions, allCurrenciesOptions } from "../../utils/dropdown-options";
...
function ConvertForm({ value, onSubmit }: ConvertFormProps) {
  ...
  let fromCurrency = selectedFromCurrency ? settings.currencies[selectedFromCurrency] : undefined;
  if (!fromCurrency) fromCurrency = selectedFromCurrency ? settings.fiatCurrencies[selectedFromCurrency] : undefined;

  let toCurrency = selectedToCurrency ? settings.currencies[selectedToCurrency] : undefined;
  if (!toCurrency) toCurrency = selectedToCurrency ? settings.fiatCurrencies[selectedToCurrency] : undefined;
        ...
        <Controller
          ...
          as={
            <SelectDropdown
              ...
              options={allCurrenciesWithBalanceOptions(
                settings.currencies,
          ...
          as={
            <SelectDropdown
              ...
              options={allCurrenciesOptions(
                {...settings.currencies, ...settings.fiatCurrencies}
              )}
            />
          }
        />
