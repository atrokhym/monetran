...
function ConvertReview({
  ...
  let fromCurrency = settings.currencies[fromCode];
  if (!fromCurrency) fromCurrency = settings.fiatCurrencies[fromCode];

  let toCurrency = settings.fiatCurrencies[toCode];
  if (!toCurrency) toCurrency = settings.currencies[toCode];
