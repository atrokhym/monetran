...
const VALID_WYRE_ADDRESS_REGEX = new RegExp("[a-zA-Z0-9]$");

//const LIBRA_PREFIX = "diem://";
const WYRE_PREFIX = "wyre://";
...
function parseDiemAddress(address: string): AddressWithIntents {
  ...
  if (address.startsWith(WYRE_PREFIX)) {
    address = address.substring(WYRE_PREFIX.length);
  }
