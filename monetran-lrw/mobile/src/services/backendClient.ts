...
export default class BackendClient {
  ...
  constructor(access_token?: string) {
    // @ts-ignore
    const baseURL = process.env.BACKEND_URL || "http://sandbox-app.monetran.com/api";
          //"http://192.168.1.22:8080/api";
          //"https://demo-wallet.diem.com/api";
  ...
  async requestDepositQuote(
    ...
    return this.requestQuote("buy", toDiemCurrency, fromFiatCurrency, microdiems, paymentMethod);
  }
  ...
  async requestWithdrawQuote(
    ...
    return this.requestQuote("sell", fromDiemCurrency, toFiatCurrency, microdiems, paymentMethod);
  }
